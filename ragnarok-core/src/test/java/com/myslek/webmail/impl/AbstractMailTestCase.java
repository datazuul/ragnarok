...
public abstract class AbstractMailTestCase extends TestCase {
	...
	protected MailMessage createMailMessage() throws Exception {
		...
		mailMessage.addRecipient(com.myslek.webmail.domain.RecipientType.TO, TO);
		mailMessage.addRecipient(com.myslek.webmail.domain.RecipientType.CC, CC1);
		mailMessage.addRecipient(com.myslek.webmail.domain.RecipientType.CC, CC2);
		mailMessage.addRecipient(com.myslek.webmail.domain.RecipientType.BCC, BCC1);
		mailMessage.addRecipient(com.myslek.webmail.domain.RecipientType.BCC, BCC2);
